...
public class TestSelenium_Fluent_Wait {
...
//        }
        ...
        Assert.assertTrue(error_message.getText().contains("Your email, password, IP address or location did not match"),
                "Expected error message to be present, but got: '" + error_message.getText() + "'");
        driver.quit();
